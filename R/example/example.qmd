...
```{r}
printTIR(estTIR(data, method = "naive", time = c(0, 4200), range = c(70, 180), boot = 20))
```
...
```{r}
printTIR(estTIR(data, method = "proposed", time = c(0, 4200), range = c(70, 180), boot = 20))
```
...
```{r}
printTIR(estTIR(data, method = "proposed", model = "cox", formula = "x1+x2", time = c(0, 4200), range = c(70, 180), boot = 20))
```
